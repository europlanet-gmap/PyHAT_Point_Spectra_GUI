...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.chooseMethod.setItemText(1, ("Ratio"))
        self.chooseMethod.setItemText(2, ("DS - Direct Standardization"))
        self.chooseMethod.setItemText(3, ("PDS - Piecewise DS"))
        self.chooseMethod.setItemText(4, ("Forward Backward DS"))
        self.chooseMethod.setItemText(5, ("Incremental Proximal Descent DS"))
        self.chooseMethod.setItemText(6, ("LASSO DS"))
        self.chooseMethod.setItemText(7, ("CCA - Canonical Correlation Analysis"))
