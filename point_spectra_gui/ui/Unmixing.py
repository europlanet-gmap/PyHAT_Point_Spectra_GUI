...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.chooseMethodLabel)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.chooseMethodComboBox)
        self.dim_reduction_vlayout = QtWidgets.QVBoxLayout()
        self.dim_reduction_vlayout.setObjectName("dim_reduction_vlayout")
        self.formLayout.setLayout(3, QtWidgets.QFormLayout.SpanningRole, self.dim_reduction_vlayout)
        self.endmemberslabel = QtWidgets.QLabel(self.formGroupBox)
        self.endmemberslabel.setObjectName("endmemberslabel")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.endmemberslabel)
        self.endmemberscomboBox = QtWidgets.QComboBox(self.formGroupBox)
        self.endmemberscomboBox.setObjectName("endmemberscomboBox")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.endmemberscomboBox)
